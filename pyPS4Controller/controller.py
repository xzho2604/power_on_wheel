...
class Actions:
    ...
    def on_x_press(self): # going right
        message = {"on_x_press": True}
        print(message)
        self.s.sendto(json.dumps(message).encode(),self.server_address)

    def on_x_release(self):
        message = {"on_x_release": True}
        print(message)
        self.s.sendto(json.dumps(message).encode(),self.server_address)

    def on_triangle_press(self): # going left
        message = {"on_triangle_press": True}
        print(message)
        self.s.sendto(json.dumps(message).encode(),self.server_address)

    def on_triangle_release(self):
        message = {"on_triangle_release": True}
        print(message)
        self.s.sendto(json.dumps(message).encode(),self.server_address)
    ...
    def on_up_arrow_press(self):
        message ={"on_up_arrow_press":True}
        print(message)
